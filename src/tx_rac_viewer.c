...
static const u8 sText_Rand_WildLevelScaled[]  = _("LVL-SCALED WILDS");
static const u8 sText_Rand_Legendaries[]      = _("RANDOM LEGENDS");
static const u8 sText_Rand_MovesVGC[]         = _("MOVE POOL");
...
static const u8 sText_Rand_AbilitiesVGC[]     = _("ABILITY POOL");
static const u8 sText_Rand_ItemsVGC[]         = _("ITEM POOL");
static const u8 sText_Rand_TMsVGC[]           = _("TM POOL");
