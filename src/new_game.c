...
static void SetDefaultOptions(void)
{
    ...
    gSaveBlock2Ptr->optionsEvenFasterJoy = 0;
    ...
    gSaveBlock2Ptr->optionsSkipIntro = 0;
    ...
    gSaveBlock2Ptr->optionsRunType = 3;                 // hold B to run before a battle starts
